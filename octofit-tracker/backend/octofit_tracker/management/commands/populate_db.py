...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Skipping deletion since collections are empty
        ...
        Workout.objects.create(name='Flight Training', description='Aerobic workout for flying heroes', suggested_for='DC')
